...
class InvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post investments_url, params: { investment: { amount: @investment.amount, investor_id: @investment.investor_id, listing_id: @investment.listing_id } }
    end
  ...
  test "should update investment" do
    patch investment_url(@investment), params: { investment: { amount: @investment.amount, investor_id: @investment.investor_id, listing_id: @investment.listing_id } }
